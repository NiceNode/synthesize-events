...
import {
	copyPreviousWeekMonthActiveNodes,
	indexActiveNodeSets,
	indexSingleNodeReport,
	initializeDateConstants,
} from "./activeNodesIndexing";
...
export const dayBeforeDayToIndexYyyyMmDd = dateToYyyyMmDd(
	dayBeforeDayToIndexDate,
);
/**
...
console.log(
	`Indexing for day: ${dayToIndexYyyyMmDd} and today is: ${TODAY_YYYY_MM_DD}. Day before index day is: ${dayBeforeDayToIndexYyyyMmDd}`,
);
...
export const dailyIndexingRoutine = async (): Promise<void> => {
	...
	await iterateSet(
		eventsRedisClient,
		makeAEventsByDayPrefix(dayToIndexYyyyMmDd),
		processEvent,
	);
